...
제1조(개인정보의 처리목적)
아름다움을 감각하다 세니아의원(이하 ‘병원’)은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이
...
`
  ...
  Xenia Clinic (ต่อไปนี้เรียกว่า ""โรงพยาบาล"") ประมวลผลข้อมูลส่วนบุคคลเพื่อวัตถุประสงค์ดังต่อไปนี้ ข้อมูลส่วนบุคคลที่ได้รับการจัดการจะไม่ใช้เพื่อวัตถุประสงค์อื่นนอกเหนือจากวัตถุประสงค์ต่อไปนี้
